...
namespace Mozart_Framework
{
    class Program
    {
        ...
        static string fileLocate = @"C:\Users\marc8847\Documents\Wave\";
        ...
        {
            {
                for (int i = 0; i < Minuetten.GetUpperBound(0) + 1; i++)
                {
                    ...
                    soundPlayer.SoundLocation = $@"{fileLocate}M{Minuetten[i, dice1 + dice2 - 2]}{fileType}";
                    soundPlayer.Load();
